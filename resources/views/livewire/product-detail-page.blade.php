                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                ...
                                <input type="number" wire:x-model='quantity' readonly class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="{{ $quantity }}">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click.prevent='addToCart({{$product->id }})' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                                ...
                                <x-bx-loader-alt wire:loading wire:target='addToCart({{ $product->id }})' class="w-4 animate-spin fill-white" />
                            </button>
                        </div>
                    </div>
                </div>
