            ...
            <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
                    <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                        ...
                        <a class="font-medium {{ request()->is('/') ? 'text-blue-600 hover:text-blue-400' : 'text-gray-500 hover:text-gray-400'}} py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="/" aria-current="page">
                            Home
                        </a>
                        <a class="font-medium {{ request()->is('categories') ? 'text-blue-600 hover:text-blue-400' : 'text-gray-500 hover:text-gray-400'}} py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="/categories">
                            Categories
                        </a>

                        <a class="font-medium {{ request()->is('products') ? 'text-blue-600 hover:text-blue-400' : 'text-gray-500 hover:text-gray-400'}} py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="/products">
                            Products
                        </a>

                        <a class="font-medium flex items-center {{ request()->is('cart') ? 'text-blue-600 hover:text-blue-400' : 'text-gray-500 hover:text-gray-400'}} py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="/cart">
